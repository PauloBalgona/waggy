...
@section('content')
    ...
    <div class="account-page">
        ...
        <div class="d-flex align-items-center gap-3 mb-5">
            <a href="{{ route('setting') }}" class="btn p-0 border-0 text-white d-flex align-items-center"
        ...
        <div class="d-flex flex-column" style="max-width: 800px;">
            <a href="{{ route('editprofile') }}" class="btn text-white text-start border-0 p-0 py-3 text-decoration-none"
                id="optionEditProfile"
                style="font-size: 20px; font-weight: 400; border-bottom: 1px solid rgba(255, 255, 255, 0.1);">
                Edit Profile
            </a>

            <a href="{{ route('changepassword') }}" class="btn text-white text-start border-0 p-0 py-3 text-decoration-none"
                id="optionChangePassword"
                style="font-size: 20px; font-weight: 400; border-bottom: 1px solid rgba(255, 255, 255, 0.1);">
                Change Password
            </a>

            <a href="{{ route('delete-account') }}" class="btn text-white text-start border-0 p-0 py-3 text-decoration-none"
                id="optionDeleteAccount" style="font-size: 20px; font-weight: 400;">
                Delete Account
            </a>
        </div>
    </div>
