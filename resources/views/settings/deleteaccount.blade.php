...
@section('content')
    ...
    <div class="d-flex align-items-center gap-3 mb-4">
        <button class="btn p-0 border-0 text-white d-flex align-items-center" id="backButton" style="font-size: 25px;">
    ...
    <div class="d-flex justify-content-center">
        <div style="max-width: 400px; width: 100%; position: relative; margin-top: 80px;">
            ...
            <form method="POST" action="{{ route('delete-account') }}">
                ...
                <div class="mb-4">
                    <input type="password" name="password" class="form-control border-0 rounded-3" placeholder="Password"
                        required style="padding: 10px 14px; font-size: 14px; background-color: #ffffff; color: #2d3748;">
                </div>
