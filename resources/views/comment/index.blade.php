        ...
        <div style="margin-top: 1.5rem;">
            ...
            <div style="display: flex; flex-direction: column; gap: 1rem;">
                @forelse ($comments as $comment)
                    <div style="display: flex; gap: 0.75rem; align-items: flex-start;" id="comment-wrapper-{{ $comment->id }}">
                        ...
                        @if($comment->replies->count() > 0)
                            <div style="margin-left: 2.75rem; margin-top: 0.75rem; border-left: 2px solid #374151; padding-left: 0.75rem;">
        ...
        function deleteComment(commentId) {
            if (confirm('Are you sure you want to delete this comment?')) {
                ...
                if (commentWrapper) {
                    ...
                    commentWrapper.style.transition = 'opacity 0.3s ease';
                    setTimeout(() => {
